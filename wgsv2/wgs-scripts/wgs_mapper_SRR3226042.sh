...
SRR3226042.bam -T PREFIX.bam && echo "* * * * sort bam done..."

rm -f SRR3226042.bam

# 步骤三 标记重复
time $GATK MarkDuplicates -I SRR3226042.sorted.bam -O SRR3226042.sorted.markdup.bam \
-M SRR3226042.sorted.markup_metrics.txt && echo "* * * * MarkDuplicates bam done..."
...
-O SRR3226042.g.vcf && echo "* * * * Generate gvcf done..."
