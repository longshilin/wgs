...
SRR3226039.bam -T PREFIX.bam && echo "* * * * BAM sort done * * * *"

rm -f SRR3226039.bam

# 步骤三 标记重复
time $GATK MarkDuplicates -I SRR3226039.sorted.bam -O SRR3226039.sorted.markdup.bam \
-M SRR3226039.sorted.markup_metrics.txt && echo "* * * * markup done * * * "
...
-O SRR3226039.g.vcf && echo "** gvcf done **"

rm -f SRR3226039.sorted.markdup.bam* SRR3226039.sorted.markup_metrics.txt
